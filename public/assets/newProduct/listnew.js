    ...
    var KTDatatableRecordSelectionDemo = function(){
        //check device size for responsive view
        ...
        options={
            ...
            toolbar: {
             ...
             //column definition   Actual Table rendering starts here.
                columns:[
                        {
                        field: 'Id',
                        title: '#',
                        ...
                        template: function(row){
                            if(row.product_image=='Y')
                            {
                                return '\
                                    <div class="cssbox">\
                                        <a id="image'+row.Id+'" href="#image'+row.Id+'">\
                                            <img class="cssbox_thumb" src="https://via.placeholder.com/117x117.png?text=No Image" />\
                                            <span class="cssbox_full"><img src="https://via.placeholder.com/500x500.png?text=No Image" /></span>\
                                        </a>\
                                ...
                                return '\
                                    <div class="cssbox">\
                                        <a id="image'+row.Id+'" href="#image'+row.Id+'">\
                                            <img class="cssbox_thumb" src="'+row.product_image+'" style="width:117px;height:auto" />\
                                            <span class="cssbox_full"><img src="'+row.product_image+'" /></span>\
                                        </a>\
                                        <a class="cssbox_close" href="#void"></a>\
                                    </div>\ ';
                            }
