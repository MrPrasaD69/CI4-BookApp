            ...
            <div class="card-toolbar ">
              ...
              <!--  <div class="topbar-item right-panel-new"> -->
                <div id="new_records" class="new-record">
                  ...
                  <a href="<?= base_url()?>/console/newProduct/newAdd" class="btn btn-primary font-weight-bolder">
  ...
  function deleteData(id,row_id)
  {
    swal.fire({
      ...
      if(result.value){
        ...
        $.ajax({
          url:'<?php echo base_url("console/newProduct/newDelete"); ?>',
          type:'POST',
          data:'id='+id,
   ...
   function manageData(id='')
   {
      swal.fire({
         ...
         if(result.value) 
         {
            window.open('<?php echo base_url("console/newProduct/newUpdate?id="); ?>'+id, "_self");
         }
